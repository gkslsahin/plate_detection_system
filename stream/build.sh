...
sudo g++ main.cpp -o plate_video_stream -L /usr/local/lib/ -lopencv_core -lopencv_imgcodecs -lopencv_videoio -lopencv_imgproc -lopencv_highgui -lopencv_objdetect -lpthread -lopenalpr
